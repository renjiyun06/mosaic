...
class UserMessageBroker:
    ...
    def push_from_worker(self, user_id: int, message: dict):
        ...
        Uses call_soon_threadsafe to enqueue in main loop.
        ...
        Note:
            ...
            It will schedule the message delivery in the main event loop.
        """
        ...
        # Cross-thread safe message delivery
