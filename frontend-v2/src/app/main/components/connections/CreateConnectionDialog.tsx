        ...
        <div className="relative z-10 space-y-4 p-5">
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              rows={3}
              maxLength={500}
              className="w-full resize-none rounded-xl border border-white/20 bg-slate-800/50 px-3 py-2.5 text-sm text-white placeholder:text-slate-500 focus:border-cyan-400/50 focus:outline-none focus:ring-2 focus:ring-cyan-400/20 backdrop-blur-xl transition-all cyberpunk-scrollbar-thin"
            />
